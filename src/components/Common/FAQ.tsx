                            ...
                            <div className="p-4">
                                ...
                                <div className="mb-2">
                                    ...
                                    <div className="p-2 text-justify text-left text-gray-800 mb-5 bg-white">
                                        ...
                                        <span className="font-bold">adipisicing elit</span>. Mollitia temporibus
                                        doloremque non eligendi unde ipsam? Voluptatibus, suscipit deserunt quidem
                                        delectus perferendis velit molestias, veritatis officia fugiat cumque quaerat
                                        earum adipisci?
                                    </div>
                                </div>
                                <div className="mb-2">
