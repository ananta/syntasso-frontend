...
const FooterLink: React.FC<FooterProps> = ({ title, to, className, isNew }) => (
  <Link to={to} className="my-3 block" href="/#">
    {title} <span className="text-teal-600 text-xs p-1">{isNew && 'New'}</span>
  </Link>
);
      ...
      <div className="bg-gray-100">
        <div className="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-center">
          <div className="p-5 w-48 ">
            <FooterTitle title="Home" />
            <FooterLink title="Services" to="/services" />
            <FooterLink title="Products" to="/products" />
            <FooterLink title="About us" to="/about" />
            <FooterLink title="Pricing" to="/pricing" />
            <FooterLink title="Partners" to="/partners" isNew={true} />
          </div>
          <div className="p-5 w-48 ">
            <FooterTitle title="User" />
            <FooterLink title="Sign in" to="/login" />
            <FooterLink title="New Account" to="/account" />
            <FooterLink title="Demo" to="/demo" isNew />
          </div>
          <div className="p-5 w-48 ">
            <FooterTitle title="Resources" />
            <FooterLink title="Documentation" to="/docs" />
            <FooterLink title="New Account" to="/login" isNew />
          ...
          <div className="p-5 w-48 ">
            ...
            <FooterLink title="Conditions" to="/conditions" />
          </div>
          <div className="p-5 w-48 ">
            <FooterTitle title="Contact us" />
            <FooterLink title="Syntasso.io" to="/contact" />
            <FooterLink title="admin@syntasso.io" to="/contact" />
          </div>
        </div>
      </div>
