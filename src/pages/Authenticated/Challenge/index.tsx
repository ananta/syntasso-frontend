...
const Challenge: React.FC<ChallengeParams> = (RouteProps) => {
  ...
  const handleCopyLink = () => {
    ...
    toast.success('Copied Problem URL to clip board');
  };
        ...
        <div className="w-full lg:w-1/4 px-3">
          ...
          <div className="p-1 mt-4 mb-4">
            ...
            <div className="flex items-center  mt-4">
              <a
                target="_blank"
                href={Linkgenerator({ path: challengeURL, social: 'twitter' })}
                className="mr-2 text-gray-800 hover:text-gray-700 cursor-pointer"
              >
              ...
              <a
                target="_blank"
                href={Linkgenerator({ path: challengeURL, social: 'facebook' })}
                className="mr-2 text-gray-800 hover:text-gray-700 cursor-pointer"
              >
              ...
              <button
                ...
                className="mr-2 text-gray-800 hover:text-gray-700 cursor-pointer focus:outline-none"
              >
                <svg
