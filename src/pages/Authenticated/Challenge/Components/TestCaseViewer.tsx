    ...
    <div className="flex mt-12 bg-white rounded-md shadow">
      <div className="w-64 bg-gray-100 rounded-l-md border-r border-dashed border-gray-200">
        ...
        <div className="mt-8 border-t border-gray-200">
          <p className="block py-3 px-6 text-gray-700 font-semibold border-b border-gray-200">Test Case #1</p>
          <p className="bg-gray-700 block py-3 px-6 font-semibold border-b border-gray-200 text-white">Test Case #1</p>
        </div>
      </div>
      <div className="flex-grow">
        <div className="flex flex-col mx-20 my-10">
          <div className="flex items-center mb-4">
            ...
            <textarea
              disabled
              className="flex-grow border border-gray-200 rounded py-1 px-3"
              value="Unable to infer path to ace from script src..."
            />
          </div>
          <div className="flex items-center mb-4">
