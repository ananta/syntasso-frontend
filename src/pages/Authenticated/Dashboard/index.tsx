...
import { TitleText, MediumTitle, RegularText } from 'components/Common/CustomText';
            ...
            <div className="mt-16">
                ...
                <div className="block space-x-0 lg:flex lg:space-x-6">
                    <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                        ...
                        <div className="p-4 pl-0">
                            ...
                            <p className="text-gray-700 mt-2">
                                Syntasso.io brings you the fun of solving Projecteuler challenges with hidden test cases
                                and time limit.
                            </p>
                    ...
                    <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                        ...
                        <div className="p-4 pl-0">
                            ...
                            <p className="text-gray-700 mt-2">
                                Join Sytasso.io&apos;s Hack the Interview coding contest to show off your skills and
                                practice for interviews. The top scorers from the Asia Pacific region will have a chance
                                to win Amazon gift cards worth up to $500.
                            </p>
                    ...
                    <div className="rounded w-full lg:w-1/2 lg:w-1/3 p-4 lg:p-0">
                        ...
                        <div className="p-4 pl-0">
                            ...
                            <p className="text-gray-700 mt-2">
                                Join Sytasso.io&apos;s Hack the Interview coding contest to show off your skills and
                                practice for interviews. The top scorers from the United States region will have a
                                chance to win Amazon gift cards worth up to $500.
                            </p>
                ...
                {/* <div className="mt-10">
                    <div className="flex justify-between">
                        <MediumTitle>Ongoing Contest</MediumTitle>
                        <div className="bg-gray-700 px-10 justify-center text-center align-middle">
                            <RegularText classNames="text-white text-center">View all contest</RegularText>
                        </div>
                    </div>
                </div> */}
            </div>
