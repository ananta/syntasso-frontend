...
const Challenges: React.FC<ContestChallengeProps> = ({ contestId }) => {
  ...
  const handleChallengeRemove = () => {
    // TODO
    alert('Are you sure you wanna remove challenges.');
    console.log('Removing the challenge.');
  };
          ...
          <div className="mx-auto">
            <div className="inputs w-full p-6">
              <InfoWithButton onClick={handleOpenModal} title="Add Challenge">
                <div>
                  Add challenges to your contest by selecting challenges from our library or create and add your own
                  challenges here.
                </div>
              </InfoWithButton>
            </div>
                                ...
                                <tr key={indx.toString()}>
                                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div className="flex items-center">
                                      ...
                                      <div className="ml-3">
                                        <Link to={`/challenge/${challenge.challengeId}/details`}>
