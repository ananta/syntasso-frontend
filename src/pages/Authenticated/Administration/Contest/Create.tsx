        ...
        <div className="mx-auto">
          <div className="inputs w-full max-w-6xl p-6">
            ...
            <p className="text-sm md:text-base text-gray-600 italic mt-2 mb-4">
              Host your own coding contest on Syntasso.io. You can participate and compete with friends from your
              organization or school. Select rom our libarry of over 100+ coding challenges or create your own.
            </p>
            <p className="text-sm md:text-base text-gray-600 italic mt-2 mb-4">
