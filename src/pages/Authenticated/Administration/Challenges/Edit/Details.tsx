...
const Details: React.FC<EditPageProps> = (EditPageProps) => {
    ...
    const getChallengeDetails = async () => {
        ...
        setInput((state) => ({
            ...
            inputFormat:
                EditorState.createWithContent(convertFromRaw(JSON.parse(sampleInput)), null) ||
                EditorState.createEmpty(),
            constraints:
                EditorState.createWithContent(convertFromRaw(JSON.parse(constraints)), null) ||
                EditorState.createEmpty(),
            outputFormat:
                EditorState.createWithContent(convertFromRaw(JSON.parse(sampleOutput)), null) ||
                EditorState.createEmpty(),
        }));
    };
                                        ...
                                        <div className="flex flex-1 mb-32 md:mb-20">
                                            <Editor
                                                ...
                                                onEditorStateChange={(editorState) =>
                                                    handleChange('problemStatement', editorState)
                                                }
                                            />
                                        </div>
                                    </div>
                                    <div className="md:flex w-full md:w-full  mb-6 ">
                                        ...
                                        <div className="flex flex-1 mb-32 md:mb-20">
                                            <Editor
                                                ...
                                                editorClassName="block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                                                onEditorStateChange={(editorState) =>
                                                    handleChange('inputFormat', editorState)
                                                }
                                            />
                                        </div>
                                    </div>
                                    <div className="md:flex w-full md:w-full  mb-6 ">
                                        ...
                                        <div className="flex flex-1 mb-32 md:mb-20">
                                            <Editor
                                                ...
                                                editorClassName="block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                                                onEditorStateChange={(editorState) =>
                                                    handleChange('constraints', editorState)
                                                }
                                            />
                                        </div>
                                    </div>
                                    <div className="md:flex w-full md:w-full  mb-6 ">
                                        ...
                                        <div className="flex flex-1 mb-32 md:mb-20">
                                            <Editor
                                                ...
                                                editorClassName="block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                                                onEditorStateChange={(editorState) =>
                                                    handleChange('outputFormat', editorState)
                                                }
                                            />
                                        </div>
                                    </div>
