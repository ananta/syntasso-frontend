...
const Features = () => {
  ...
  <div className="container px-5 py-20 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">      
      <h1 className=" text-5xl font-medium title-font text-gray-900">Our Features</h1>
    </div>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/3">
        <div className="flex rounded-lg h-full bg-gray-200 p-8 flex-col">
          <div className="flex flex-row content-center justify-center">
        <div className="w-16 h-16 pr-1">
        <svg
      ...
      <div className="p-4 md:w-1/3">
        ...
        >
          <g>
            <path
              d="M8,11l0,2l4,0l0,2l-4,0l0,6l6,0l0,-2l-4,0l0,-2l4,0l0,-6l-6,0Z"
              style={{ fillRule: 'nonzero' }}
            ></path>
            <path
              d="M21,15l0,-4l-2,0l0,4l-1,0l0,-4l-2,0l0,6l3,0l0,4l2,0l0,-4l2,0l0,-2l-2,0Z"
              style={{ fillRule: 'nonzero' }}
            ></path>
            <path
              d="M26.917,10.799l-1.832,0.801c0.607,1.389 0.915,2.869 0.915,4.4c0,6.065 -4.935,11 -11,11c-6.065,0 -11,-4.935 -11,-11c0,-6.065 4.935,-11 11,-11l0,2l5,-3l-5,-3l0,2c-7.168,0 -13,5.832 -13,13c0,7.168 5.832,13 13,13c7.169,0 13,-5.832 13,-13c0,-1.81 -0.364,-3.56 -1.083,-5.201Z"
              style={{ fillRule: 'nonzero' }}
            ></path>
          </g>
        </svg>
          ...
          <div className="flex items-center">           
            <h2 className="text-gray-900 text-2xl title-font font-medium">Reliable</h2>
          </div>
          </div>
          <div className="flex-grow">
