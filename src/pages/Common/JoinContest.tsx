    ...
    const handleInitiation = async () => {
        try {
            ...
            setContestInfo((contestInfo) => ({
                ...contestInfo,
                ...contestInfoResponse.response.contest,
            }));
                    ...
                    <div className="relative lg:grid lg:grid-cols-2 lg:col-gap-8">
                        <div className="mt-10 sm:grid sm:grid-cols-2 sm:col-gap-8 sm:row-gap-10 lg:col-span-2 lg:mt-0">
                            <div>
                                ...
                                <div className="mt-5">
                                    <h5 className="text-lg leading-6 font-medium text-gray-900 text-center">
                                        Start Time
                                    </h5>
                ...
                <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:text-center">
                        ...
                        <p className="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
                            ...
                            veritatis in accusamus quisquam. Lorem ipsum dolor sit amet consect adipisicing elit.
                            Possimus magnam voluptatum cupiditate veritatis in accusamus quisquam. Lorem ipsum dolor sit
                            amet consect adipisicing elit. Possimus magnam voluptatum cupiditate veritatis in accusamus
                            quisquam.oLorem ipsum dolor sit amet consect adipisicing elit. Possimus magnam voluptatum
                            cupiditate veritatis in accusamus quisquam. Lorem ipsum dolor sit amet consect adipisicing
                            elit. Possimus magnam voluptatum cupiditate veritatis in accusamus quisquam. Lorem ipsum
                            dolor sit amet consect adipisicing elit. Possimus magnam voluptatum cupiditate veritatis in
                            accusamus quisquam.
                        </p>
                    </div>
                </div>
